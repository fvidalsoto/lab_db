...
$('#form-insert').on('submit', function (e) {
  ...
  const condicionSGBD = $('#opcion').val() == null;
  const condicionTabla = $('#opcion2').val() == null;

  if ( condicionSGBD && condicionTabla){
    messageAlert('Error', 'Debes elegir un SGBD y una tabla', 'error');
  }else if (condicionSGBD){
    messageAlert('Error', 'Debes elegir un SGBD', 'error');
  }else if (condicionTabla){
    messageAlert('Error', 'Debes elegir una tabla', 'error');
  }else{
